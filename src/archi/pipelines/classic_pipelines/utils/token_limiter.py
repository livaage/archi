...
class TokenLimiter:
    def __init__(
        ...
        self.INPUT_SIZE_WARNING = "WARNING: your last message is too large for the model archi is running on. Please reduce the size of your message, and try again. The variable {var} was found to be too large."
